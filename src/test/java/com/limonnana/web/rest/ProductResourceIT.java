...
public class ProductResourceIT {
    ...
    public void setup() {
        ...
        final ProductResource productResource = new ProductResource(productRepository, categoryRepository, keyWordRepository, categoryService, productService);
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPictureUrl()).isEqualTo(DEFAULT_PICTURE_URL);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getPictureUrl()).isEqualTo(UPDATED_PICTURE_URL);
    }
