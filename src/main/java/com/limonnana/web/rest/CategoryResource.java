...
/**
 * REST controller for managing {@link com.limonnana.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    public ResponseEntity<Category> createCategory(@Valid @RequestBody Category category) throws URISyntaxException {
        ...
        if(category.getCategory() != null) {
            Category categoryParent = categoryRepository.findById(category.getCategory().longValue()).get();
            Set<Category> categoryList = categoryParent.getCategories();
            categoryList.add(category);
            result =  categoryRepository.save(categoryParent);
        }else {
